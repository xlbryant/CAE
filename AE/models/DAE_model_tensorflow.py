...
class AdditiveDAE(object):
    def __init__(self, n_input, n_hidden, name_scope,transfer_function = tf.nn.softplus, optimizer = tf.train.AdamOptimizer(), scale = 0.1 ):
    ...
    def partial_fit_re_cost_only(self, X):
